package com.nkosana.globalkineticweatherapp.lib.app;
...
import com.nkosana.globalkineticweatherapp.R;
import com.nkosana.globalkineticweatherapp.lib.SlidingMenu;
...
public class SlidingActivityHelper {
    ...
    public void onCreate(Bundle savedInstanceState) {
        mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.lib_slidingmenu, null);
    }
